...
INSERT INTO product
	(reference, product_name, current_price, unit, description, image_url, is_daily_product) VALUES
    ('GC0001', 'Poudre de fée', 150, 'unité', 'Poudre magique, guérisseur, médiévale, elfique', 'https://i.ibb.co/HfdM4X8P/image7.png', TRUE),
    ('GC0002', 'Chemise mithril', 100, 'unité', 'Armure légère mais incroyablement résistante', 'https://i.ibb.co/gFFdxnTg/image3.png', FALSE),
    ('GC0003', 'Anneau invisibilité', 200, 'unité', 'Devenez invisible à volonté', 'https://i.ibb.co/fYvHjqLr/image8.png', FALSE);
...
-- Activer l'extension pgcrypto (à faire une seule fois)
CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- Insertion des utilisateurs
INSERT INTO "user" (phone_number, first_name, last_name, pseudo, hash_password) VALUES
('0000000000', 'Aragorn', 'Elessar', 'lelexirGorn', crypt('Anduril#2025', gen_salt('bf'))),
('0000000001', 'Éomer', 'Éomund', 'ernestor', crypt('RohanStrong!', gen_salt('bf'))),
('0000000002', 'Legolas', 'Thranduilion', 'ThorEdmur', crypt('ElvenSight@01', gen_salt('bf')));
